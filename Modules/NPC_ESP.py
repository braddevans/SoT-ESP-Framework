...
class NPC_ESP(DisplayObject):
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = NPCS_AND_PLAYERS.get(self.raw_name).get("Name")

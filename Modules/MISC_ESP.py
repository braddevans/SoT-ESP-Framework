...
class MISC_ESP(DisplayObject):
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.name = fixthese.get(self.raw_name).get("Name")
